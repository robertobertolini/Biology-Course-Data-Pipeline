# Data pipeline incorporating the information gain feature seletion technique during
...
of="Week9_Both_IG_Significant_GLMNET.xlsx"
of2="Week9_Both_IG_Significant_GLMNET_Score.xlsx"
...
for (k in 1:10){
  ...
  weights <- information.gain(crse_grade_off_ccat~.,listofdfs_train[[k]])
  print(k)
...
write.csv(auc_test,'AUC_GLMNET_Week9_Both_IG.csv')
write.csv(accu,'ACCURACY_GLMNET_Week9_Both_IG.csv')
write.csv(sensit,'SENSIT_GLMNET_Week9_Both_IG.csv')
write.csv(specif,'SPECIF_GLMNET_Week9_Both_IG.csv')
write.csv(bal_acc,'BALACC_GLMNET_Week9_Both_IG.csv')
write.csv(cut_point,'CP_GLMNET_Week9_Both_IG.csv')
write.csv(youden_j,'YOUDEN_GLMNET_Week9_Both_IG.csv')
write.csv(f1,'F1_GLMNET_Week9_Both_IG.csv')
write.csv(tp,'TP_GLMNET_Week9_Both_IG.csv')
write.csv(tn,'TN_GLMNET_Week9_Both_IG.csv')
write.csv(fn,'FN_GLMNET_Week9_Both_IG.csv')
write.csv(fp,'FP_GLMNET_Week9_Both_IG.csv')